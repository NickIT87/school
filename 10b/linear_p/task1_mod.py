...
# calculate objective function values on the meshgrid
aa, bb = np.meshgrid(a_vals, np.linspace(0, 300, 100))
cc = (300 - aa - bb)
z = 13 * aa + 18 * bb + 22 * cc

# add contour line for objective function
plt.contour(aa, bb, z, levels=[z_value], colors=['magenta'], linewidths=[2])
